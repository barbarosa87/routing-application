...
public class RREPACK extends AODVMessage {
	...
	*/
	public RREPACK(ConfigInfo cfg, CurrentInfo cur, UDPPacket up, String iface) throws Exception {
	...
	*
	*/
	public RREPACK(ConfigInfo cfg, CurrentInfo cur, boolean mf, InetAddress sendto, short ttl)
					 throws Exception {
