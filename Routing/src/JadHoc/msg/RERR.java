...
public class RERR extends AODVMessage {
	...
	*/
	public RERR(ConfigInfo cfg, CurrentInfo cur, UDPPacket up, String iface) throws Exception {
	...
	*/
	...
	public RERR(ConfigInfo cfg, CurrentInfo cur, boolean mf, InetAddress sendto, short ttl,
	...
	*/
	private void breakDgramToIPv4RERR() throws Exception {
		...
		for(int j = 0; j < destCount; j++){
			...
			destIPAddr[j] = getInetByAddress(addr1);
