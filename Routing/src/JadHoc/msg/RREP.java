...
public class RREP extends AODVMessage {
	...
	*/
	public RREP(ConfigInfo cfg, CurrentInfo cur, UDPPacket up, String iface) throws Exception {
	...
	*
	*/
	public RREP(ConfigInfo cfg, CurrentInfo cur, boolean mf, InetAddress sendto, short ttl,
