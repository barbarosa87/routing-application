...
public class RREQ extends AODVMessage {
	...
	*/
	...
	public RREQ(ConfigInfo cfg, CurrentInfo cur, UDPPacket up, String iface) throws Exception {
	...
	*
	*/
	public RREQ(ConfigInfo cfg, CurrentInfo cur, boolean mf, InetAddress sendto, short ttl,
	...
	*/
	private void breakDgramToIPv4RREQ() throws Exception {
		...
		destIPAddr = getInetByAddress(addr1);
		...
		origIPAddr = getInetByAddress(addr2);
