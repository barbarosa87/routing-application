...
/**
* This Class provides the functionality to transmit packets on a Zaurus
...
*
*/
public class PacketSenderZaurus implements PacketSenderInterface {
	...
	*/
	public PacketSenderZaurus(ConfigInfo cfg, CurrentInfo cur) throws Exception {
		cfgInfo = cfg;
		curInfo = cur;
	}
	...
	*/
	public void sendMessage(AODVMessage msg) throws Exception {
		mcastSock.setTTL((byte) msg.ttlValue);
