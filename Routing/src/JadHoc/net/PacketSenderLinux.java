...
import jadhoc.msg.*;
import jadhoc.conf.*;
import jadhoc.net.PacketSenderInterface;
import jadhoc.other.*;

/**
* This Class provides the functionality to transmit packets in Linux
...
*  11-feb-2004  class name change
* 		introduced interface
*
*/
public class PacketSenderLinux implements PacketSenderInterface {
	...
	*/
	public PacketSenderLinux(ConfigInfo cfg, CurrentInfo cur) throws Exception {
		cfgInfo = cfg;
		curInfo = cur;
	}
